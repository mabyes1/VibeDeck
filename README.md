...
Put in the web files you want and VibeDeck will discover the Deck automatically. See `docs/custom-data-sources-spec.md` and the bundled `src/VibeDeck.Host/DeckExamples/coding-pet/` example for the current extension model.
